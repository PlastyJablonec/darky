...
export function Register() {
  ...
  // Získat návratovou URL z query parametrů
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // OAuth redirect se postará o přesměrování
    } catch (err) {
        ...
        <div className="flex-1 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
          ...
          <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Zkontrolujte svůj e-mail a klikněte na potvrzovací odkaz 
              pro dokončení registrace.
            </p>
            <Link
              to={`/login${returnTo !== '/wishlists' ? `?returnTo=${encodeURIComponent(returnTo)}` : ''}`}
